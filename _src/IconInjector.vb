...
'		2018
'   @note
'       I'm not sure where the original source of the "IconInjector" class came from. I noticed that
'       I cannot replicate what this class does in C++, hence why I built this separate .exe in vb.net instead.
'
